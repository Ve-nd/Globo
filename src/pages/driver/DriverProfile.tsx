      ...
      <div className="bg-gray-900 pt-safe-top pb-16 px-4">
        ...
        <div className="flex items-center gap-4">
          <div className="w-20 h-20 rounded-full bg-white border-4 border-gray-800 shadow-soft overflow-hidden">
            <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=200&fit=crop" alt="الملف الشخصي" className="w-full h-full object-cover" />
          </div>
          <div className="text-white">
            <h2 className="text-2xl font-bold">Youssef B.</h2>
            <div className="flex items-center gap-2 text-yellow-400 font-bold mt-1">
              <Star size={16} className="fill-yellow-400" /> 4.9 <span className="text-gray-400 text-sm font-medium">(124 رحلة)</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 px-4 -mt-8 space-y-4 pb-24">
        <div className="grid grid-cols-2 gap-4">
          <Card className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-gray-500 font-bold uppercase">الحالة</p>
              <p className="font-bold text-gray-900">موثق</p>
            </div>
          </Card>
          <Card className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-gray-500 font-bold uppercase">المستوى</p>
              <p className="font-bold text-gray-900">محترف</p>
            </div>
          </Card>
        </div>
        ...
        <Card className="p-4 space-y-4 mt-2">
          <div className="flex items-center justify-between pb-4 border-b border-gray-100">
            <div>
              <h3 className="font-bold text-gray-900">المركبة</h3>

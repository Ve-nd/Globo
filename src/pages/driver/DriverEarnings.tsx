  ...
  return (
    <div className="min-h-full bg-gray-50 flex flex-col">
      <div className="bg-gradient-primary pt-safe-top pb-16 px-4">
        <h1 className="text-xl font-bold text-white mt-2 mb-6">Earnings</h1>
        <p className="text-white/80 text-sm font-bold uppercase tracking-wider mb-1">Today's Total</p>
      ...
      <div className="flex-1 px-4 -mt-8 space-y-4 pb-24">
        <div className="grid grid-cols-2 gap-4">
          <Card className="p-4 text-center">
            <p className="text-gray-500 text-xs font-bold uppercase tracking-wider mb-1">Deliveries</p>
            <h3 className="text-2xl font-extrabold text-gray-900">12</h3>
          </Card>
          <Card className="p-4 text-center">
            <p className="text-gray-500 text-xs font-bold uppercase tracking-wider mb-1">Distance</p>
            <h3 className="text-2xl font-extrabold text-gray-900">45<span className="text-sm">km</span></h3>
          </Card>
        </div>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-primary text-sm font-bold flex items-center">
              Oct 12 - 18 <ChevronRight size={16} />
            </button>
          </div>
        ...
        <h3 className="font-bold text-gray-900 mt-6 mb-2 px-1">Recent Transactions</h3>
        <Card className="overflow-hidden">
          {[
            { id: '1', store: 'Pizza House', time: '14:30', amount: 25, distance: '3.2 km' },
            { id: '2', store: 'Burger Factory', time: '13:15', amount: 18, distance: '1.5 km' },
            { id: '3', store: 'Pharmacie Centrale', time: '12:00', amount: 15, distance: '0.8 km' },
            { id: '4', store: 'Sushi Time', time: '11:20', amount: 35, distance: '5.1 km' },
          ].map((tx, i, arr) => (

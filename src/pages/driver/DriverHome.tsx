    ...
    <div className="min-h-full bg-gray-50 flex flex-col pb-20">
      <div className="bg-white px-4 pt-safe-top pb-4 sticky top-0 z-20 shadow-sm border-b border-gray-100">
        <div className="flex justify-between items-center mt-2">
          <div>
            ...
            <p className="text-xs text-gray-500 font-medium">Looking for nearby deliveries...</p>
          </div>
          <button 
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-gradient-primary rounded-2xl p-4 text-white shadow-soft flex items-center justify-between">
          <div>
            <p className="text-white/80 text-xs font-bold uppercase tracking-wider mb-1">Today's Earnings</p>
        ...
        {!isOnline ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h3 className="font-bold text-gray-900 text-lg mb-2">You are offline</h3>
            <p className="text-gray-500 text-sm">Go online to start receiving delivery requests.</p>
          </div>
        ) : (
          <div className="space-y-4 pt-2">
            <h3 className="font-bold text-gray-900 text-sm uppercase tracking-wider px-1">Nearby Requests</h3>
                ...
                >
                  <Card interactive className="p-4" onClick={() => navigate(`/driver/order/${order.id}`)}>
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <span className="text-xs font-bold bg-blue-50 text-blue-600 px-2 py-1 rounded-md mb-2 inline-block">New Request</span>
                      ...
                      <div className="text-right">
                        ...
                        <span className="text-xs font-bold text-gray-400">{order.distance} km total</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 bg-gray-50 p-3 rounded-xl mb-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-xs text-gray-400 uppercase font-bold tracking-wider mb-0.5">Drop-off</p>

    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Manage operational cities, delivery zones, and city-specific settings.</p>
        </div>
          ...
          <Card className="border-2 border-primary/20 overflow-hidden relative">
            ...
            <div className="p-5 flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg text-gray-900 leading-tight mb-1">Casablanca</h3>
                <div className="flex items-center gap-2 mb-3">
                  <Badge variant="green">Operational</Badge>
                  <span className="text-xs text-gray-500 font-bold">• 112 Stores</span>
                </div>
                ...
                <div className="space-y-2 mt-4">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-bold text-gray-900">15 km</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-500">Base Del. Fee</span>
                    <span className="font-bold text-gray-900">10 MAD</span>
                  </div>
                </div>

                <div className="mt-6 flex gap-2">
                  <Button variant="secondary" className="flex-1 py-2 text-sm">Edit Settings</Button>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-5 flex items-start gap-4 opacity-70 grayscale-[30%]">
            ...
            <div className="flex-1">
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="font-bold text-lg text-gray-900 leading-tight mb-1">Rabat</h3>
              ...
              <p className="text-sm text-gray-500 mt-4">Setup incomplete. Missing delivery zones and merchant onboarding.</p>
              <Button variant="secondary" className="w-full mt-4 py-2 text-sm">Resume Setup</Button>
            </div>
          </Card>
        </div>
          ...
          <Card className="h-full flex flex-col min-h-[500px]">
            <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-white z-10">
              <h3 className="font-bold text-gray-900 flex items-center gap-2">
                ...
                Casablanca Coverage Map
              </h3>
              <div className="flex gap-2">
                <Button variant="secondary" size="sm" className="flex items-center gap-2">
                  <Settings2 size={16} /> Map Tools
                </Button>
              </div>
            </div>
            ...
            <div className="flex-1 bg-[#E8F0F2] relative overflow-hidden">
              ...
              <div className="absolute left-[30%] top-[40%] w-[300px] h-[300px] bg-primary/20 rounded-full flex items-center justify-center border-2 border-primary/50 -translate-x-1/2 -translate-y-1/2">
                ...
                <span className="absolute top-1/2 mt-2 text-primary font-bold text-sm bg-white/80 px-2 rounded">Zone A</span>
              </div>
              ...
              <div className="absolute left-[60%] top-[30%] w-[200px] h-[200px] bg-blue-500/20 rounded-full flex items-center justify-center border-2 border-blue-500/50 -translate-x-1/2 -translate-y-1/2">
                ...
                <span className="absolute top-1/2 mt-2 text-blue-600 font-bold text-sm bg-white/80 px-2 rounded">Zone B</span>
              </div>
              ...
              <div className="absolute left-[45%] top-[70%] w-[250px] h-[250px] bg-green-500/20 rounded-full flex items-center justify-center border-2 border-green-500/50 -translate-x-1/2 -translate-y-1/2">
                ...
                <span className="absolute top-1/2 mt-2 text-green-600 font-bold text-sm bg-white/80 px-2 rounded">Zone C</span>
              </div>
            </div>
            ...
            <div className="p-4 border-t border-gray-100 bg-white">
              <div className="flex gap-6">
                <div>
                  <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mb-1">Total Coverage Area</p>
                  <p className="font-bold text-gray-900">~125 sq km</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mb-1">Est. Population Reached</p>
                  <p className="font-bold text-gray-900">2.4 Million</p>
                </div>
              </div>
            </div>
          </Card>

    ...
    <div className=\"max-w-7xl mx-auto space-y-6\">
      <div className=\"flex flex-col md:flex-row md:items-center justify-between gap-4\">
        <div>
          ...
          <p className=\"text-gray-500 text-sm mt-1\">إدارة المدن التشغيلية، ومناطق التوصيل، والإعدادات الخاصة بكل مدينة.</p>
        </div>
        ...
        <div className=\"lg:col-span-1 space-y-4\">
          ...
          <Card className=\"p-5 flex items-start gap-4 opacity-70 grayscale-[30%]\">
            ...
            <div className=\"flex-1\">
              ...
              <p className=\"text-sm text-gray-500 mt-4\">الإعداد غير مكتمل. تفتقد لمناطق التوصيل وضم التجار.</p>
          ...
          <Card className=\"h-full flex flex-col min-h-[500px]\">
            ...
            <div className=\"p-4 border-t border-gray-100 bg-white\">
              <div className=\"flex gap-6\">
                <div>
                  <p className=\"text-xs text-gray-500 font-bold uppercase tracking-wider mb-1\">إجمالي منطقة التغطية</p>
                  <p className=\"font-bold text-gray-900\">~125 كم مربع</p>
                </div>
                <div>
                  <p className=\"text-xs text-gray-500 font-bold uppercase tracking-wider mb-1\">عدد السكان المتوقع الوصول إليهم</p>

        ...
        <div className="md:col-span-2 space-y-6">
          <Card className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-bold text-gray-900 mb-1">نسبة عمولة المنصة %</label>
                <p className="text-xs text-gray-500 mb-2">العمولة الافتراضية المقتطعة من التجار.</p>
              ...
              <div>
                <label className="block text-sm font-bold text-gray-900 mb-1">نسبة أجر السائق %</label>
                <p className="text-xs text-gray-500 mb-2">نسبة رسوم التوصيل التي يحصل عليها السائق.</p>
                <div className="relative">
          ...
          <Card className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100">
                <div>
                  <h3 className="font-bold text-gray-900 text-sm">فرض تحديث التطبيق</h3>
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <div className="p-4 bg-red-50 border border-red-100 rounded-xl text-center">
              <p className="text-sm font-bold text-red-800 mb-3">مفتاح الإيقاف الاضطراري</p>
              <p className="text-xs text-red-600 mb-4">سيؤدي هذا إلى إيقاف المنصة بالكامل للعملاء فوراً. ستبقى عمليات التوصيل النشطة قيد التنفيذ.</p>
              <Button variant="danger" fullWidth>إيقاف عمل المنصة</Button>
            </div>
          </Card>
        </div>
      </div>

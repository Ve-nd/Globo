    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-500 font-medium">All You Want.</p>
        </motion.div>
        ...
        >
          <motion.div variants={item}>
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg">Customer App</h3>
                <p className="text-sm text-gray-500">Order food, groceries & more</p>
              </div>
          ...
          <motion.div variants={item}>
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg">Merchant Dashboard</h3>
          ...
          <motion.div variants={item}>
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="font-bold text-lg">Driver App</h3>
                <p className="text-sm text-gray-500">Accept & deliver orders</p>
              </div>
              <ArrowRight className="text-gray-300" />
            </Card>
          </motion.div>
          ...
          <motion.div variants={item}>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">Platform overview & settings</p>
              </div>
              <ArrowRight className="text-gray-300" />
            </Card>
          </motion.div>

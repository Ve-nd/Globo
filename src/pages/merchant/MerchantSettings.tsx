    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Manage your business profile and availability.</p>
        </div>
        ...
        <div className="md:col-span-2 space-y-6">
          <Card className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-bold text-gray-900 mb-1">Store Name</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-900 mb-1">Contact Phone</label>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between items-center mb-1">
                  <label className="block text-sm font-bold text-gray-900">Delivery Radius</label>
                  <span className="text-primary font-bold text-sm">5 km</span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div>
                  <label className="block text-sm font-bold text-gray-900 mb-1">Min. Order (MAD)</label>
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-900 mb-1">Est. Prep Time (min)</label>
            ...
            <div className="space-y-4">
              {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'].map((day, i) => (
                <div key={day} className="flex items-center justify-between">
                  ...
                  {i === 6 ? (
                    <span className="text-xs font-bold text-red-500 bg-red-50 px-2 py-1 rounded">Closed</span>
                  ) : (

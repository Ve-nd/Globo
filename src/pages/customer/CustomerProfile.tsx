  ...
  return (
    <div className="min-h-full bg-gray-50 flex flex-col">
      <div className="bg-primary pt-safe-top pb-16 px-4">
        ...
        <div className="flex items-center gap-4">
          <div className="w-20 h-20 rounded-full bg-white border-4 border-white shadow-soft overflow-hidden">
            <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&fit=crop" alt="Profile" className="w-full h-full object-cover" />
          </div>
      ...
      <div className="flex-1 px-4 -mt-8 space-y-4 pb-6">
        <Card className="p-4 space-y-4">
          ...
          <button className="w-full flex items-center justify-between text-left group">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Favorite Stores</h3>
                <p className="text-xs text-gray-500">3 stores saved</p>
              </div>
            </div>
            <ChevronRight size={20} className="text-gray-300 group-hover:text-primary transition-colors" />
          </button>
        ...
        <h3 className="font-bold text-sm text-gray-500 uppercase tracking-wider px-2 pt-2">Settings</h3>

...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(({ 
  ...
  const variants = {
    primary: 'bg-gradient-primary shadow-soft hover:shadow-floating active:scale-[0.98] text-white',
    ...
    danger: 'bg-red-50 text-accent hover:bg-red-100 active:scale-[0.98]',
  };
